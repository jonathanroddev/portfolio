    ...
    return (
        ...
        >
            <div className={`relative w-full h-full transition-transform duration-500 preserve-3d ${isFlipped ? 'rotate-y-180' : ''}`}>
                ...
                <div className="absolute w-full h-full backface-hidden flex flex-col items-center justify-center p-4 bg-slate-200 border-2 border-dashed border-sky-600 rounded-xl">
                ...
                <div className="absolute w-full h-full backface-hidden rotate-y-180 flex items-center justify-center p-4 bg-sky-600 border-2 border-sky-600 rounded-xl shadow-inner">
