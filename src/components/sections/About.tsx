...
const About: FC = () => {
    ...
    return (
        <section id="about" className="bg-slate-300 w-full dark:bg-slate-600 transition-colors duration-300">
            <div className="container flex flex-wrap mx-auto md:pt-32 pt-16 px-2 sm:px-4">
                ...
                <div className="w-full md:w-2/3 flex justify-center px-4 md:px-0">
                    <article className="sm:w-9/12">
                        <h3 className="font-recursive text-5xl text-sky-600 font-normal text-center mb-4 md:mt-0 mt-10 motion-safe:animate-bounce dark:text-sky-400 transition-colors duration-300">{t('about-title')}</h3>
                        <p className="font-inter text-2xl text-slate-700 md:font-extralight font-light text-justify indent-14 dark:text-slate-300 transition-colors duration-300">
